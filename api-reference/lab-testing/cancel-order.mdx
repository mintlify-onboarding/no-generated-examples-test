    ...
    "order": {
      ...
      "properties": {
        "user_id": {
          "title": "User Id",
          "type": "string",
          "description": "User id returned by bazinga create user request. This id should be stored in your database against the user and used for all interactions with the bazinga api.",
          "format": "uuid"
        },
        "user_key": {
          "title": "User Key",
          "type": "string",
          "description": "User key returned by bazinga create user key request. This key should be stored in your database against the user and used for all interactions with the bazinga api.",
          "format": "uuid",
          "deprecated": true
        },
        "id": {
          "title": "Id",
          "type": "string",
          "description": "The Bazinga Order ID",
          "format": "uuid"
        },
        "team_id": {
          "title": "Team Id",
        ...
        "lab_test": {
          ...
          "description": "The Bazinga Test associated with the order"
        },
        "details": {
          "title": "Details",
          "anyOf": [
                ...
                "data": {
                  ...
                  "properties": {
                    "id": {
                      "title": "Id",
                      "type": "string",
                      "description": "The Bazinga walk-in test Order ID",
                      "format": "uuid"
                    },
                    "created_at": {
                      "title": "Created At",
                ...
                "data": {
                  ...
                  "properties": {
                    "id": {
                      "title": "Id",
                      "type": "string",
                      "description": "The Bazinga TestKit Order ID",
                      "format": "uuid"
                    },
                    "shipment": {
                      "title": "Shipment",
                      "allOf": [
                        {
                          ...
                          "properties": {
                            "id": {
                              "title": "Id",
                              "type": "string",
                              "description": "The Bazinga Shipment ID",
                              "format": "uuid"
                            },
                            "outbound_tracking_number": {
                            ...
                            "notes": {
                              "title": "Notes",
                              "type": "string",
                              "description": "Notes associated to the Bazinga shipment"
                            }
                          },
